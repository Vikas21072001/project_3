...
class train:
    def __init__(self, name='', num=0, arr_time=0, dep_time=0, src='', des='', day_of_travel='', seat_available_in_1AC=0
                 , seat_available_in_2AC=0, seat_available_in_SL=0, fare_1ac=0, fare_2ac=0, fare_sl=0):
        self.name = name
        self.num = num
    ...
    def check_availablity(self, coach='', ticket_num=0):
        ...
        if coach not in ('SL','1AC','2AC'):
            ...
            if self.seats[coach] == 0:
                ...
                return False
    def book_ticket(self, coach='', no_of_ticket=0):
        self.seats[coach] -= no_of_ticket
        return True
...
def create_new_acc():
    ...
    hometwon = input("Enter your hometwon:- ")
    cell_num = input("Enter your Cell Number:- ")
    u = user(uid, user_name, hometwon, cell_num, pwd)
    print("Your User ID is:- ", uid,'\n')
    print("NOTE:- Please Remener Your User_ID & Password")
    print('\n\n')
...
u1 = user(2222,'vikas','Tanuku','9381133022','vikas')
u2 = user(3355,'ramesh_gupta','banglore','7873752967','ramesh_gupta')
...
print(26*"-","WELCOME TO RAILWAY RESERVATION PORTAL",26*"-")
print(60*"-")
load()
